//[androidutils](../../../index.md)/[com.jeovanimartinez.androidutils.about](../../index.md)/[AboutActivity](../index.md)/[Companion](index.md)
...
|  Name|  Summary| 
|---|---|
| <a name="com.jeovanimartinez.androidutils.about/AboutActivity.Companion/STATE_TERMS_AND_POLICY_VISIBLE/#/PointingToDeclaration/"></a>[STATE_TERMS_AND_POLICY_VISIBLE](-s-t-a-t-e_-t-e-r-m-s_-a-n-d_-p-o-l-i-c-y_-v-i-s-i-b-l-e.md)| <a name="com.jeovanimartinez.androidutils.about/AboutActivity.Companion/STATE_TERMS_AND_POLICY_VISIBLE/#/PointingToDeclaration/"></a> [androidJvm] const val [STATE_TERMS_AND_POLICY_VISIBLE](-s-t-a-t-e_-t-e-r-m-s_-a-n-d_-p-o-l-i-c-y_-v-i-s-i-b-l-e.md): [String](https://kotlinlang.org/api/latest/jvm/stdlib/kotlin/-string/index.html)   <br>

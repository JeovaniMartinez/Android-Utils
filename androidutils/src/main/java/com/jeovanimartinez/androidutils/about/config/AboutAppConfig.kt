...
data class AboutAppConfig(
    @param:DrawableOrDrawableRes val appLogo: Any,
    @param:StringOrStringRes val appName: Any,
    @param:StringOrStringRes val appVersion: Any,
    @param:StringOrStringRes val creditsText: Any,
    @param:StringOrStringRes val creditsUrl: Any?,
    @param:DrawableOrDrawableRes val authorLogo: Any,
    @param:StringOrStringRes val authorUrl: Any?,
    @param:StringOrStringRes val copyrightHolderName: Any,
    @param:StringOrStringRes val termsAndPrivacyPolicyUrl: Any?,
    val showOpenSourceLicenses: Boolean,
    @param:StringOrStringRes val helpCenterUrl: Any?,
    @param:StringOrStringRes val crashReportEmail: Any?,
    @param:StringOrStringRes val contactEmail: Any?,
    @param:StringOrStringRes val feedbackEmail: Any?,
